...
const { verifyToken, refreshAccessToken, rateLimit, validateInput } = require('../middleware/auth');
 ...
 * Update user profile
 */
router.put('/profile', verifyToken, validateInput(updateProfileSchema), async (req, res) => {
  try {
