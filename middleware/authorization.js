  ...
  return async (req, res, next) => {
    try {
      ...
      const rolePermissions = {
        'OWNER': ['all'],
        'ADMIN': ['manage-team', 'manage-settings', 'delete-project', 'manage-reviews', 'read-members'],
        'MAINTAINER': ['create-review', 'approve-review', 'merge-code', 'manage-issues', 'read-members'],
        'CONTRIBUTOR': ['write-code', 'create-review', 'comment-review', 'read-members'],
