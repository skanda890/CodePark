...
void learnIfStatements(){
    ...
    cout << "An 'if' statement lets the computer do different things based on whether a condition is true or false.\n";
...
int main() {
    ...
    do {
        ...
        switch (choice) {
            case 1: learnVariables(); break;
            case 2: learnOutput(); break;
            case 3: learnInput(); break;
            case 4: learnIfStatements(); break;
            case 0: cout << "Goodbye! Keep coding!\n"; break;
