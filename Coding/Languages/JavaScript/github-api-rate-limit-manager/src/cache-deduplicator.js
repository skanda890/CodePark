...
class CacheDeduplicator {
  ...
  getStats() {
    ...
    return {
      ...
      utilizationPercentage: ((this.cache.size / this.maxCacheSize) * 100).toFixed(2) + '%',
  ...
  getHealth() {
    ...
    return {
      ...
      recommendation: hitRate < 60 ? 'Consider increasing TTL or cache size' : 'Cache is working well'
    };
  }
