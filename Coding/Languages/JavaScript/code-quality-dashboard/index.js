...
const resolvers = {
  Query: {
    metrics: async (_, { limit }) => {
      ...
      const metrics = { timestamp: new Date().toISOString(), totalFiles: 100, totalIssues: 28, errorCount: 3, warningCount: 25, averageComplexity: 7.2, overallScore: 72.5, files: [] };
...
app.get('/health', (req, res) => res.json({ status: 'ok', service: 'code-quality-dashboard' }));
